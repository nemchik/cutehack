...
Examples:<br />
<font class=pass>CORRECT</font>: include("cutenews/show_news.php");<br />
<font class=error>WRONG&nbsp;&nbsp;&nbsp;</font>: include("http://site.com/cutenews/show_news.php");<br />
<br />
...
When you send your news to the archive, CuteNews will automatically create a new archive file under the ./archives/ folder with extension .arch.php .
Then all news that you selected for archiving will be moved from news.db.php (where only the active news are hold) to the newly created file in archives/
...
opening the archive file and copying its content to news.db.php<br /><br />
...
<h1>Explaining the custom category option</h1>
<p>
...
/* ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 ...
 ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ */
if (isset($section)) {
    if (!isset($help_sections["$section"])) {
        die("Can not find the specified section <b>$section</b>");
    }
    echo"<HTML>
    <style type=\"text/css\">
	<!--
